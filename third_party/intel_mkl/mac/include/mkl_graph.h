...
/*
*  Graph functionality has been added to MKL as a preview feature with limited functionality. The
*  supported functionality and API will be extended in future releases to provide better coverage of
...
typedef enum
{
    ...
    MKL_GRAPH_SEMIRING_LOR_LAND_BOOL      = 4,  /* for simple BFS */
    MKL_GRAPH_SEMIRING_MIN_PLUS_INT32     = 5,  /*  */
    MKL_GRAPH_SEMIRING_MIN_PLUS_INT64     = 6,  /*  */
    MKL_GRAPH_SEMIRING_MIN_PLUS_FP32      = 7,  /*  */
    MKL_GRAPH_SEMIRING_MIN_PLUS_FP64      = 8,  /*  */
    MKL_GRAPH_SEMIRING_MAX_FIRST_INT32    = 9,  /*  */
    MKL_GRAPH_SEMIRING_MAX_FIRST_INT64    = 10, /*  */
    MKL_GRAPH_SEMIRING_MAX_FIRST_FP32     = 11, /*  */
    MKL_GRAPH_SEMIRING_MAX_FIRST_FP64     = 12  /*  */
...
typedef enum
{
    MKL_GRAPH_MODIFIER_OUTPUT             = 0, /* This one is for descriptor */
    MKL_GRAPH_MODIFIER_FIRST_INPUT        = 1, /* This one is for descriptor */
    MKL_GRAPH_MODIFIER_SECOND_INPUT       = 2, /* This one is for descriptor */
    MKL_GRAPH_MODIFIER_MASK               = 3 /* This one is for descriptor */
} mkl_graph_descriptor_field_t;

typedef enum
{
    MKL_GRAPH_NO_MODIFIER                 = 0, /*  */
    MKL_GRAPH_STRUCTURE_COMPLEMENT        = 1, /*  */
    MKL_GRAPH_TRANSPOSE                   = 2, /*  */
    MKL_GRAPH_REPLACE                     = 3, /*  */
    MKL_GRAPH_ONLY_STRUCTURE              = 4, /*  */
    MKL_GRAPH_KEEP_MASK_STRUCTURE         = 5  /*  */
} mkl_graph_descriptor_field_value_t;

typedef enum
{
    MKL_GRAPH_METHOD_AUTO                 = 0, /* automatic choice     */
    MKL_GRAPH_METHOD_DOT                  = 1, /* 1-stage dot product  */
    MKL_GRAPH_METHOD_DOT_TWOSTAGE         = 2, /* 2-stage dot product  */
    MKL_GRAPH_METHOD_GUSTAVSON            = 3, /* Gustavson */
    MKL_GRAPH_METHOD_GUSTAVSON_TWOSTAGE   = 4, /* for future use */
    MKL_GRAPH_METHOD_HEAP                 = 5  /* for future use */
} mkl_graph_method_t;

typedef enum
{
    MKL_GRAPH_REQUEST_COMPUTE_ALL         = 0, /* compute all arrays associated with the output at once, 1-stage method */
    MKL_GRAPH_REQUEST_COMPUTE_NNZ         = 1, /* compute only number of nonzeros (possibly per row or column) of the output object */
    MKL_GRAPH_REQUEST_COMPUTE_STRUCTURE   = 2, /* compute only structure of the output object */
    MKL_GRAPH_REQUEST_COMPUTE_VALUES      = 3  /* perform multiplication with values (full matrix) */
} mkl_graph_request_t;
...
/* For matrices */
mkl_graph_status_t mkl_graph_matrix_create (mkl_graph_matrix_t *A_ptr);
mkl_graph_status_t mkl_graph_matrix_destroy(mkl_graph_matrix_t  A);

/* For vectors */
mkl_graph_status_t mkl_graph_vector_create (mkl_graph_vector_t *v_ptr);
mkl_graph_status_t mkl_graph_vector_destroy(mkl_graph_vector_t  v);

/* For descriptors */
mkl_graph_status_t mkl_graph_descriptor_create (mkl_graph_descriptor_t *desc_ptr);
...
mkl_graph_status_t mkl_graph_matrix_set_csr (mkl_graph_matrix_t A,
                                                ...
                                                void *rows_start,
                                                mkl_graph_type_t rows_start_type,
                                                void *col_indx,
                                                mkl_graph_type_t col_indx_type,
                                                void  *values,
...
mkl_graph_status_t mkl_graph_optimize_mxv(mkl_graph_matrix_t A, int64_t ncalls);
mkl_graph_status_t mkl_graph_optimize_mxm(mkl_graph_matrix_t A, int64_t ncalls);
