 ...
 * functions like:
 *    void op_XXXXXX_mkl(CTorchOperator *);
 */
#define MKL_OP_FUNC_NAME(op) op_##op##_mkl
#define MKL_OP_FUNC_DECLARE(op) void MKL_OP_FUNC_NAME(op)(CTorchOperator *);
 ...
 */
extern void (*fps_op_mkl[ENABLED_OP_NUM])(CTorchOperator *);
